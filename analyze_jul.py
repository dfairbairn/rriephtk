...
for i in range(29): #TODO: don't concat them together, but sift them together.
...
rdms = rdm4.T[0] # TBH I don't know what purpose is served by rdm1.T[i] for i = 1,2.. 
size = np.size(rdms)

# Samprate, approximately is # samples divided by the 146 seconds for the data
samprate = 2155.  #316722/146 = 2169.3356~ 2155. works good #/62500.33933 
time0 = ephem_times[0]
