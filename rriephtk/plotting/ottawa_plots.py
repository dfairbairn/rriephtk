...
def get_ottawa_data(date_string):
    ...
    if "20160418"==date_string:
        fname = data_path+"/RRI_20160418_222759_223156_lv1_v2.h5" #18th
        index_reversal = 167 #for 18th # Stay
    elif "20160419"==date_string:
        #index_reversal = 178 #for 19th # Could go -1
        index_reversal = 177
        fname = data_path+"/RRI_20160419_220939_221336_lv1_v2.h5" #19th
    elif "20160420"==date_string:
        index_reversal = 212 #for Apr20th updated May 1 2017 consulting w Glenn
        fname = data_path+"/RRI_20160420_215117_215514_lv1_v2.h5" #20th
    elif "20160421"==date_string:
        #index_reversal = 205 #?? for 21st? # Could go up +5
        index_reversal = 210
        fname = data_path+"/RRI_20160421_213255_213652_lv1_v2.h5" #21st
    elif "20160422"==date_string:
        #index_reversal = 222 #for 22nd # Could go down -1 
        index_reversal = 221
        fname = data_path+"/RRI_20160422_211435_211832_lv1_v2.h5" #22nd
    else:
...
def plot_ottawa_ephem(date_string):
    ...
    *** RETURNS ***
    ...
    m.plot(x,y,'yo',label=("Reversal Point of Faraday Rotation"))
...
def plot_all5():
    ...
    x,y = m(elliplon_18th, elliplat_18th, coords='geo')
    m.plot(x,y,'yo',markersize=4,label=("Inflection of Ellipticity Angle"))
